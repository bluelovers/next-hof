...
const job100: IJobDef = {
	no: 100,
	job_name: 'Warrior',
	equip: ['Sword', 'TwoHandSword', 'Shield', 'Armor', 'Cloth', 'Robe', 'Item'],
...
const skills: ISkillDef[] = [
	{
		...
		target: ['enemy', 'individual', 1], pow: 100,
	},
	{
		no: 2000, name: 'FireStorm', exp: '施展火焰风暴', sp: 70, type: 1,
		target: ['enemy', 'multi', 6], pow: 100, invalid: 1, charge: [70, 0],
	},
	{
		no: 3000, name: 'Healing', exp: '治療', sp: 5, type: 0,
		target: ['friend', 'individual', 1], pow: 200, support: 1,
	},
	{
		no: 3040, name: 'Revive', exp: '蘇生', sp: 0, type: 0,
		target: ['friend', 'individual', 1], pow: 100, revive: 1,
	},
];
...
const items: IItemDef[] = [
	{
		no: 1000, name: 'ShortSword', type: 'Sword', type2: 'WEAPON', img: 'we_sword026',
		buy: 500, atk: [10, 0], def: [0, 0, 0, 0], handle: 1, need: { 6001: 4 }, base_name: 'ShortSword',
	},
	{
		no: 3000, name: 'WoodShield', type: 'Shield', type2: 'ARMOR', img: 'we_shield001',
		buy: 200, atk: [0, 0], def: [5, 5, 0, 0], handle: 1, need: { 6001: 1, 6020: 4 }, base_name: 'WoodShield',
	},
	{
		no: 5000, name: 'ClothArmor', type: 'Armor', type2: 'ARMOR', img: 'ar_cloth001',
...
const char100: ICharDef = {
	...
	equip: { main_hand: 1000, off_hand: 3000, armor: 5000 },
	behavior: {
		position: 'front', guard: 'always',
		pattern: [
...
const mon1000: IMonDef = {
	...
	behavior: { position: 'front', guard: 'always', pattern: [{ judge: 1000, quantity: 0, action: 1000 }] },
};
...
const mon1001: IMonDef = {
	...
	behavior: { position: 'back', guard: 'never', pattern: [{ judge: 1000, quantity: 0, action: 2000 }] },
};
