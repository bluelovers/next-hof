...
import { BattleUnit } from '../src/components/BattleDisplay/BattleUnit';
import type { IBattleUnit } from '../src/components/BattleDisplay/types';
...
const meta: Meta<typeof BattleUnit> = {
  ...
  decorators: [
    (Story) => (
      <div style={{ background: '#10151b', padding: '20px', borderRadius: '4px', width: '300px' }}>
        <Story />
      </div>
    ),
  ],
